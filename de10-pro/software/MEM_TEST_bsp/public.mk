...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../DE10_Pro_QSYS/DE10_Pro_QSYS.sopcinfo
...
# Design Name 
# setting SOPC_NAME is DE10_Pro_QSYS
SOPC_NAME := DE10_Pro_QSYS
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x40081050
SOPC_SYSID_FLAG += --sidp=0x40081050
ELF_PATCH_FLAG  += --sidp 0x40081050

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 0
SOPC_SYSID_FLAG += --timestamp=0
ELF_PATCH_FLAG  += --timestamp 0
