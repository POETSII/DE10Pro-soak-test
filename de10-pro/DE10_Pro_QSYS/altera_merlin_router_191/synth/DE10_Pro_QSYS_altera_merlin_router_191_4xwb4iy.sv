...
module DE10_Pro_QSYS_altera_merlin_router_191_4xwb4iy_default_decode
  #(
...
module DE10_Pro_QSYS_altera_merlin_router_191_4xwb4iy
(
    // -------------------
    // Clock & Reset
    // -------------------
    ...
    DE10_Pro_QSYS_altera_merlin_router_191_4xwb4iy_default_decode the_default_decode(
    ...
    // ( 0x58 .. 0x60 )
    if ( {address[RG:PAD5],{PAD5{1'b0}}} == 7'h58   ) begin
