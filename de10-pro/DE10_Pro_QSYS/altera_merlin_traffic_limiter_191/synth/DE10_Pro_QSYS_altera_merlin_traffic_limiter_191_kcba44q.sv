...
module DE10_Pro_QSYS_altera_merlin_traffic_limiter_191_kcba44q
#(
   parameter
      PKT_TRANS_POSTED           = 1,
      PKT_DEST_ID_H              = 0,
   ...
   generate
      if (REORDER) begin: fifo_dest_id_write_read_control_reorder_on
         ...
         for (j = 0;j < MAX_DEST_ID; j = j+1) begin : trans_sequence_per_fifo
            ...
            DE10_Pro_QSYS_altera_merlin_traffic_limiter_191_kxr2kva #(
                  .SYMBOLS_PER_BEAT   (1),
            ...
            //alt_hiconnect_sc_fifo # (
              DE10_Pro_QSYS_altera_merlin_traffic_limiter_191_kee6vky # (
                .IMPL                  ("reg"),
                .SYMBOLS_PER_BEAT      (1),   
